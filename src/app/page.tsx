...
export default function HomePage() {
  ...
  <div>
    ...
    <div className="text-xs text-muted-foreground">
      AI-Powered Security
            ...
            <div className="flex items-center space-x-6">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-purple-700 shadow-lg px-8 py-3"
              >
                Get Started
              </Button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="text-center lg:text-left space-y-8">
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl">
                Harness the power of AI to protect your financial institution
                with real-time fraud detection, investigation tools, and
                comprehensive analytics built specifically for Indonesian
                banking systems.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-8 pt-4">
                <Button
                  size="lg"
                  onClick={() => router.push("/register")}
                  className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-purple-700 text-lg px-12 py-6 shadow-xl"
                >
                  Start Free Trial
                  <svg
            ...
            <div className="relative">
              ...
              <div
                className="absolute -bottom-6 -left-6 w-20 h-20 bg-purple-500/20 rounded-full opacity-20 animate-ping"
        ...
        <div className="container mx-auto px-8 lg:px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Built specifically for Indonesian banking regulations and fraud
              patterns, powered by cutting-edge AI and machine learning
              technology that adapts to emerging threats.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-blue-50/50 dark:from-blue-950/20 to-card">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <CardHeader className="relative p-10">
                ...
                <CardDescription className="text-muted-foreground text-lg leading-relaxed">
                  Advanced ML algorithms analyze transactions in real-time with
                  sub-200ms response times, ensuring immediate fraud detection
                  and prevention across all payment channels.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-purple-50/50 dark:from-purple-950/20 to-card">
              ...
              <CardHeader className="relative p-10">
                ...
                <CardDescription className="text-muted-foreground text-lg leading-relaxed">
                  Fully compliant with BI-FAST, QRIS, and GPN systems. Built
                  with Indonesian banking regulations and local fraud patterns
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-green-50/50 dark:from-green-950/20 to-card">
              ...
              <CardHeader className="relative p-10">
                ...
                <CardDescription className="text-muted-foreground text-lg leading-relaxed">
                  Comprehensive fraud analytics, investigation tools, and
                  predictive insights to stay ahead of emerging threats with
      ...
      <section
        id="security"
        className="py-40 bg-gradient-to-r from-blue-900 via-blue-400 to-blue-900 text-white relative overflow-hidden"
      >
        <div className="container mx-auto px-8 lg:px-12 relative">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              Your data security is our top priority. SI JagaDana employs
              multiple layers of protection to ensure your financial data
              remains safe and compliant with international standards.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-lg leading-relaxed">
                All data stored in Indonesian data centers
              </p>
            </div>
              ...
              <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-8">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M8 9l3 3-3 3m13 0h-6m-8-4h6m4 0V9a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h14a2 2 0 002-2V9z"
                  />
                </svg>
              </div>
      ...
      <section
        id="analytics"
        className="py-40 bg-gradient-to-br from-background to-muted/20"
      >
        <div className="container mx-auto px-8 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Transform your fraud detection with comprehensive analytics that
                provide actionable insights, predictive modeling, and detailed
                investigation tools for maximum protection.
              </p>
              ...
              <div className="space-y-10 pt-8">
                <div className="flex items-start space-x-8">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground text-2xl mb-3">
                      Real-time Dashboards
                    </h3>
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      Monitor fraud patterns and trends as they happen with
                ...
                <div className="flex items-start space-x-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      Anticipate fraud before it happens with ML predictions and
                      risk scoring
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      Deep-dive analysis with network graphs and timeline views
            ...
            <div className="relative">
              <div className="bg-card rounded-3xl shadow-2xl p-10 border border-border">
                ...
                <div className="space-y-8">
                  ...
                  <div className="w-full bg-muted rounded-full h-4">
                    <div
                      className="bg-gradient-to-r from-yellow-500 to-yellow-600 h-4 rounded-full"
                      style={{ width: "2%" }}
                    ></div>
                  </div>
                </div>
      ...
      <section id="testimonials" className="py-10 bg-muted/20">
        <div className="container mx-auto px-8 lg:px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Join over 50+ Indonesian financial institutions that trust SI
              JagaDana to protect their customers and assets from sophisticated
              fraud attempts.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  "SI JagaDana has revolutionized our fraud detection
                  capabilities. The AI-powered system caught fraudulent
                  transactions that our previous system missed, saving us
                  millions."
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-6">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Head of Risk Management, Bank Nasional
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  "The real-time monitoring and investigation tools have
                  significantly reduced our response time to fraud incidents.
                  Customer satisfaction has improved dramatically."
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-6">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Chief Security Officer, Digital Bank Indonesia
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  ...
                  exceptional. Our fraud losses have decreased by 85% since
                  using SI JagaDana. Best investment we've made."
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-6">
                    ...
                    <div className="text-sm text-muted-foreground">
                      IT Director, Koperasi Sejahtera
                    </div>
                  </div>
                </div>
              </CardContent>
      ...
      >
        <div className="container mx-auto px-8 lg:px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Scale with confidence. From startups to enterprise banks, we have
              a plan that fits your needs and budget perfectly.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
            ...
            <Card className="border-2 border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="space-y-8 px-12 pb-12">
                <div className="flex items-center">
                  <svg
                    className="w-6 h-6 text-green-500 mr-6"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <Button
                  className="w-full mt-12 py-6 text-lg"
                  variant="outline"
                  onClick={() => router.push("/register")}
                >
                  Start Free Trial
            ...
            <Card className="border-2 border-blue-500 shadow-xl hover:shadow-2xl transition-shadow duration-300 relative">
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                <Badge className="bg-blue-500 text-white px-8 py-3 text-sm">
                  Most Popular
                </Badge>
              </div>
              <CardHeader className="text-center p-12">
              ...
              <CardContent className="space-y-8 px-12 pb-12">
                ...
                <Button
                  className="w-full mt-12 py-6 text-lg bg-blue-500 hover:bg-blue-600"
                  onClick={() => router.push("/register")}
                >
                  Start Free Trial
                </Button>
            ...
            <Card className="border-2 border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="text-center p-12">
                ...
                <CardDescription className="text-muted-foreground text-lg">
                  For large banks and institutions
                </CardDescription>
                <div className="mt-8">
                  <span className="text-5xl font-bold text-foreground">
                    Custom
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-600 via-blue-400 to-blue-800 text-white relative overflow-hidden">
        <div className="container mx-auto px-8 lg:px-12 text-center relative">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-16 max-w-4xl mx-auto leading-relaxed">
            Join over 50+ Indonesian financial institutions that trust SI
            JagaDana to protect their customers and prevent fraud losses. Start
    ...
    <div className="text-xs text-muted-foreground">
      AI-Powered Security
              ...
              <p className="text-muted-foreground mb-10 max-w-md text-lg leading-relaxed">
                Protecting Indonesian financial institutions with
                next-generation AI technology. Secure, compliant, and built for
          ...
          <div className="border-t border-border mt-20 pt-12">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-muted-foreground text-lg mb-8 md:mb-0">
                © 2025 SI JagaDana. All rights reserved. Built for Indonesian
                Financial Security.
              </div>
