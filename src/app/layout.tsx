...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive AI-powered fraud detection platform for Indonesian financial institutions',
  keywords: ['fraud detection', 'AI', 'financial security', 'banking', 'Indonesia'],
