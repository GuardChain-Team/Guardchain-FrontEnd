  ...
  riskFactors: [
    {
      ...
      weight: 0.8,
      description:
        "Transaksi 5x lebih besar dari rata-rata user (Rp 2,500,000 → Rp 50,000,000)",
    ...
    },
    {
      ...
      weight: 0.6,
      description:
        "Transaksi dilakukan pada pukul 02:30 WIB (di luar jam operasional normal)",
    ...
    },
    {
      ...
      weight: 0.7,
      description:
        "User biasanya melakukan 2-3 transaksi per hari, hari ini sudah 15 transaksi",
      severity: AlertSeverity.MEDIUM,
    },
    {
      id: "4",
      ...
      weight: 0.5,
      description:
        "Transaksi dari lokasi yang tidak pernah digunakan sebelumnya",
      severity: AlertSeverity.LOW,
    },
  ],
  description:
    "Transaksi senilai Rp 50,000,000 yang jauh melebihi pola normal pengguna. Analisis mendalam menunjukkan beberapa indikator risiko tinggi yang memerlukan investigasi segera.",
  assignedTo: "John Doe",
  ...
  notes: [
    {
      id: "1",
      content:
        "Alert pertama kali terdeteksi oleh ML model dengan confidence score 95%. Perlu investigasi manual segera.",
      author: "System",
    ...
    },
    {
      id: "2",
      content:
        "Menghubungi customer untuk verifikasi transaksi. Belum ada respons dalam 30 menit.",
      author: "John Doe",
    ...
    },
    {
      id: "3",
      content:
        "Customer dikonfirmasi sedang di luar negeri. Perlu verifikasi tambahan melalui OTP dan video call.",
      author: "Jane Smith",
...
export default function AlertDetailPage({ params }: AlertDetailPageProps) {
  ...
  const getAlertTypeIcon = (alertType: AlertType) => {
    switch (alertType) {
      case AlertType.AMOUNT_ANOMALY:
        return <BanknotesIcon className="h-5 w-5" />;
      case AlertType.NETWORK_RISK:
        return <ComputerDesktopIcon className="h-5 w-5" />;
      case AlertType.VELOCITY_CHECK:
        return <ClockIcon className="h-5 w-5" />;
      case AlertType.GEOLOCATION_RISK:
        return <MapPinIcon className="h-5 w-5" />;
      case AlertType.DEVICE_FINGERPRINT:
        return <ComputerDesktopIcon className="h-5 w-5" />;
      default:
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Detected {formatRelativeTime(alert.detectedAt)} • Last updated{" "}
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Model confidence: {(alert.confidence * 100).toFixed(1)}% •
                  Version: {alert.modelVersion}
                </p>
              </div>
            ...
            <TabsContent value="risk-factors">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Detailed breakdown of risk factors contributing to this
                    alert
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-3 h-3 rounded-full ${
                                factor.severity === AlertSeverity.CRITICAL
                                  ? "bg-red-500"
                                  : factor.severity === AlertSeverity.HIGH
                                  ? "bg-orange-500"
                                  : factor.severity === AlertSeverity.MEDIUM
                                  ? "bg-yellow-500"
                                  : "bg-blue-500"
                              }`}
                            />
                          ...
                          <div className="flex items-center gap-2">
                            <Badge
                              variant={getSeverityColor(factor.severity) as any}
                            >
                              {factor.severity}
                            </Badge>
                            <span className="text-sm text-muted-foreground">
                        ...
                        <div className="space-y-2 pl-6">
                          <div>
                            ...
                            <p className="font-medium">
                              {transactionDetail.senderAccount.name}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="font-mono text-sm">
                              {transactionDetail.senderAccount.accountNumber}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="text-sm">
                              {transactionDetail.senderAccount.bankName}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 pl-6">
                          <div>
                            ...
                            <p className="font-medium">
                              {transactionDetail.receiverAccount.name}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="font-mono text-sm">
                              {transactionDetail.receiverAccount.accountNumber}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="text-sm">
                              {transactionDetail.receiverAccount.bankName}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div>
                            ...
                            <p className="text-sm">
                              {transactionDetail.location.city},{" "}
                              {transactionDetail.location.region}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="font-mono text-sm">
                              {transactionDetail.location.ipAddress}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="text-sm">
                              {transactionDetail.device.type} -{" "}
                              {transactionDetail.device.os}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm text-muted-foreground">
                            ...
                            <p className="text-sm">
                              {transactionDetail.device.browser}
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {(!alert.notes || alert.notes.length === 0) &&
                  !isAddingNote && (
                    <p className="text-sm text-muted-foreground text-center py-4">
                      No investigation notes yet. Add one to start documenting
                      your analysis.
                    </p>
                  )}
              </div>
